#!/bin/sh
# This is github.com/miklosbagi/ca-sidecar
...
rm -f /output-certs/generated-by-sidecar-*
touch /output-certs/generated-by-sidecar-$(date +%Y%m%d-%H%M%S) || e "Failed to leave a note about auto-ganaeration"
# Kthxbye
